 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://datadownload.webservices.eegdatabase.kiv.zcu.cz/}dataFileInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetDataFilesResponse {
	...
	@Generated(value = "com.sun.tools.xjc.Driver", date = "2015-05-14T01:25:18+02:00", comments = "JAXB RI v2.2.4")
    protected List<DataFileInfo> _return;
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-05-14T01:25:18+02:00", comments = "JAXB RI v2.2.4")
	public List<DataFileInfo> getReturn() {
        if (_return == null) {
            _return = new ArrayList<DataFileInfo>();
        }
        return this._return;
    }
